...
///
/// ```
/// use hedl_core::visitor::{utils::PathCollector, traverse, TraversalConfig};
/// use hedl_core::Document;
///
/// let doc = Document::new((1, 0));
...
///
/// ```
/// use hedl_core::visitor::{utils::ReferenceCollector, traverse, TraversalConfig};
/// use hedl_core::Document;
///
/// let doc = Document::new((1, 0));
...
///
/// ```
/// use hedl_core::visitor::{utils::FindNode, traverse, TraversalConfig};
/// use hedl_core::{Document, Node};
///
/// let doc = Document::new((1, 0));
...
///
/// ```
/// use hedl_core::visitor::{utils::TypeCounter, traverse, TraversalConfig};
/// use hedl_core::Document;
///
/// let doc = Document::new((1, 0));
