...
fn test_empty_document() {
    ...
    // yaml_to_hedl creates v2.0 documents by default
...
fn test_empty_roundtrip_yaml() {
    ...
    // Verify empty document - yaml_to_hedl creates v2.0 by default
    assert_eq!(restored.version, (2, 0));
...
// =============================================================================
// Empty Child Sequences in Schema
// =============================================================================
